...
class PedidoItem extends TRecord
{
    ...
    /**
     * Marcar os pedidos entregues como pronto
     */
    public static function upStaus($pedido_id)
    {
        $conn = TTransaction::get();
        $conn->query("UPDATE pedido_item SET status = 'Pronto' WHERE pedido_id = $pedido_id");
    }
