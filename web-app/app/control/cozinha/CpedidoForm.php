 ...
 */
class CpedidoForm extends TPage
{
    protected $form; // form
...
//        $estado_pedido_id       = new TDBCombo('estado_pedido_id', 'microerp', 'EstadoPedido', 'id', 'nome','id asc'  );
        $mesa_pedido_id         = new TDBCombo('mesa_pedido_id', 'microerp', 'MesaPedido', 'id', 'nome','id asc'  );
        ...
        // detail fields
        $item_pedido_produto_id = new TDBCombo('item_pedido_produto_id', 'microerp', 'Produto', 'id', 'nome','id asc', $criteria);
