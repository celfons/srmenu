 ...
 */
class CpedidoFormView extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $text7  = new TTextDisplay($pedido->status, '#333333', '12px', '');
        
        $this->form->addFields([$label1],[$text1], [$label4],[$text4]);
        $this->form->addFields([$label2],[$text2], [$label5],[$text5]);
        $this->form->addFields([$label3],[$text3], [$label7],[$text7]);
    ...
    //    $this->form->addFields([$label7],[$text7]);
        ...
        $this->pedido_item_list->addQuickColumn('Status', 'status', 'center');
        ...
        $this->form->addHeaderAction('Imprimir', new TAction(['CpedidoFormView', 'onPrint'],['key'=>$pedido->id]), 'fa:file-pdf-o red');
        $this->form->addHeaderAction('Pronto', new TAction(['CpedidoList', 'onEdit'],['key'=>$pedido->id]), 'fa:pencil-square-o blue');
    //    $this->form->addAction('Pronto', new TAction([$this, 'onSave']), 'fa:floppy-o')->addStyleClass('btn-primary');
