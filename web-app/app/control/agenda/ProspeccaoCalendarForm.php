...
class ProspeccaoCalendarForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle('Prospecção');

        $view = new THidden('view');

        $id = new TEntry('id');
        $pessoa_id = new TDBUniqueSearch('pessoa_id', 'microerp', 'SystemUser', 'id', 'name','',$criteria );
        ...
        $this->form->addFields([new TLabel('Ciente:', '#ff0000')],[$pessoa_id]);
