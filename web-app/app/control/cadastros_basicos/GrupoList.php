 ...
 */
class GrupoList extends TStandardList
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('list_Grupo');

        // define the form title
        $this->form->setFormTitle('Listagem de grupos');
        ...
        $this->form->addAction('Cadastrar', new TAction(['GrupoForm', 'onEdit']), 'fa:plus #69aa46');
