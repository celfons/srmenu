<?php
/**
 * TipoMenuList Listing
 * @author  <André Luiz Ferreira>
 */
class TipoMenuList extends TStandardList
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('list_TipoMenu');

        // define the form title
        $this->form->setFormTitle('Listagem de tipo menu');
        ...
        $this->form->addAction('Cadastrar', new TAction(['TipoMenuForm', 'onEdit']), 'fa:plus #69aa46');
        ...
        $column_imagem_id = new TDataGridColumn('imagem_id', 'Codigo da Imagem', 'left');

        $this->datagrid->addColumn($column_id);
        $this->datagrid->addColumn($column_nome);
        $this->datagrid->addColumn($column_imagem_id);

        $action_onEdit = new TDataGridAction(array('TipoMenuForm', 'onEdit'));
