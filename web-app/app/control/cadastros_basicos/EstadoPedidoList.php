 ...
 */
class EstadoPedidoList extends TStandardList
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('list_EstadoPedido');
        ...
        $this->form->addAction('Cadastrar', new TAction(['EstadoPedidoForm', 'onEdit']), 'fa:plus #69aa46');
