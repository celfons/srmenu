 ...
 */
class EstadoPedidoForm extends TStandardForm
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        parent::setActiveRecord('EstadoPedido');
        
        // creates the form
        $this->form = new BootstrapFormBuilder('form_EstadoPedido');
        $this->form->setFormTitle('Estado de pedido');
        ...
        $container->add(new TXMLBreadCrumb('menu.xml', 'EstadoPedidoList'));
