...
class ProdutoReport extends TPage
{
    ...
    public function __construct()
    {
        ...
        $id = new TEntry('id');
        $tipo_produto_id = new TDBCombo('tipo_produto_id', 'microerp', 'TipoProduto', 'id', '{nome}','id asc'  );
        $nome = new TEntry('nome');
       // $fornecedor_id = new TDBCombo('fornecedor_id', 'microerp', 'SystemUnit', 'id', '{nome}','id asc'  );
...
//        $this->form->addFields([new TLabel('Nome:')],[$nome],[new TLabel('Fornecedor:')],[$fornecedor_id]);
        ...
        $this->form->addAction('Gerar HTML', new TAction([$this, 'onGenerateHtml']), 'fa:code')->addStyleClass('btn-primary');
    ...
    public function getFilters()
    {
        ...
        $filters[] = new TFilter('fornecedor_id','=',TSession::getValue('userunitid'));
            ...
            if ($objects)
            {
                ...
                if (!empty($tr))
                {
                    ...
                    foreach ($objects as $object)
                    {
                        ...
                        $tr->addCell($object->fornecedor->name, 'left', $style);
